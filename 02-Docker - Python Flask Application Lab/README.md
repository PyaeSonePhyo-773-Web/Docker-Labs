# Docker - Python Flask App & Full CLI Testing Lab
...
```bash
docker tag python-flask-app:1.0 dcwipyae/python-flask-app:1.0
```
...
```bash
docker push dcwipyae/python-flask-app:1.0
```
...
```bash
docker pull dcwipyae/python-flask-app:1.0
```
